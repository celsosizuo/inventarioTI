...
{
    public partial class FrmRateioEMail : Form
    {
        ...
        private void btnListar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if(this.rdoExchange.Checked)
                    _rateios = rateio.GetRateioEMailExchange(this.cboReferencia.Text);
                else if(this.rdoMaiex.Checked)
                    _rateios = rateio.GetRateioEMailMaiex(this.cboReferencia.Text);
                else
                    throw new Exception("Favor selecionar um tipo de conta");


                decimal totalUsuarios = _rateios.Sum(r => r.Qtde ?? 0);
                decimal totalFatura = _rateios.Sum(s => s.Valor);
        ...
        {
            DetalheFaturaEMail refer = new DetalheFaturaEMail();
