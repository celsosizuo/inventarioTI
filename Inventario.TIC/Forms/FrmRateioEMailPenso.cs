...
{
    public partial class FrmRateioEMailPenso : Form
    {
        ...
        private void btnListar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                _rateios = rateio.GetRateioEMailPenso(this.cboReferencia.Text);
        ...
        {
            DetalheFaturaEmailPenso refer = new DetalheFaturaEmailPenso();
