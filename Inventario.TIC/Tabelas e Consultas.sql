...
IF EXISTS (SELECT * fROM SYS.objects WHERE type = 'P' AND name = 'PATHCANCELARDEVOLUCAO')
	DROP PROCEDURE PATHCANCELARDEVOLUCAO

GO

CREATE PROCEDURE PATHCANCELARDEVOLUCAO
