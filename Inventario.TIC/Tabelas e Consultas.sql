...
AS
	SELECT C.*, CASE WHEN C.FONEOUVIDO = 0 THEN 'Sim' ELSE 'Não' END AS FONEOUVIDODESCRICAO, L.*, A.*, CA.*, G.*, U.*
	FROM TERMOCELULAR C
...
CREATE PROCEDURE POSTTERMOCELULARUSUARIO
	...
	@USUARIOID					INT
AS
	INSERT TERMOCELULARUSUARIO VALUES (@TERMOCELULARID, @USUARIOID)
...
*/
	...
	insert TERMOCELULARUSUARIO values (1, 19)
