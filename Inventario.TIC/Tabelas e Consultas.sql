...
-- INICIO DA IMPORTAÇÃO DAS CONTAS DE E-MAIL
...
AS  
 BEGIN  
	...
	SET VALOR = B.VALORUNITCOMIMPOSTO
	FROM DETALHEFATURAEMAIL A
	INNER JOIN PRECOCONTAEMAIL B ON B.TIPOCONTA = 'Usuários Maiex'
	WHERE TIPOREGISTRO = 'Maiex' AND
	TIPO <> 'contato' and
	POLITICA <> 'internal' AND
	REFERENCIA = @REFERENCIA
...
-- INICIO DA IMPORTAÇÃO DAS CONTAS DE TELEFONIA FIXA
...
-- INICIO DA IMPORTAÇÃO DAS CONTAS DE IMPRESSORAS
...
CREATE PROCEDURE POSTDISPOSITIVOALUGADO
	...
	@AVULSO						BIT
AS
	INSERT DISPOSITIVOALUGADO (TIPODISPOSITIVOID, USUARIOID, ATIVO, MODELO, VALOR, AVULSO) 
	VALUES (@TIPODISPOSITIVOID, @USUARIOID, @ATIVO, @MODELO, @VALOR, @AVULSO)
